...
Version  : 4.2.1
Release  : 9
URL      : https://files.pythonhosted.org/packages/08/8f/1783c57498eb39201fb688a131f73a784a77e8045ae3b8f96a5e53f78a35/humanize-4.2.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/08/8f/1783c57498eb39201fb688a131f73a784a77e8045ae3b8f96a5e53f78a35/humanize-4.2.1.tar.gz
...
%prep
%setup -q -n humanize-4.2.1
cd %{_builddir}/humanize-4.2.1
pushd ..
cp -a humanize-4.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656096685
...
cp %{_builddir}/humanize-4.2.1/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
