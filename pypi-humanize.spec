...
Source0  : https://files.pythonhosted.org/packages/db/08/dbe660b435f7dcc9cd78c928cabba90e3088c10b2a90843c102cc3671154/humanize-4.0.0.tar.gz
...
%prep
%setup -q -n humanize-4.0.0
cd %{_builddir}/humanize-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644861586
...
cp %{_builddir}/humanize-4.0.0/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
