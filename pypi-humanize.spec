...
Source0  : https://files.pythonhosted.org/packages/5d/b1/c8f05d5dc8f64030d8cc71e91307c1daadf6ec0d70bcd6eabdfd9b6f153f/humanize-4.10.0.tar.gz
...
%prep
%setup -q -n humanize-4.10.0
cd %{_builddir}/humanize-4.10.0
pushd ..
cp -a humanize-4.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720478568
