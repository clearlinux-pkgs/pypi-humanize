...
Version  : 4.2.2
Release  : 10
URL      : https://files.pythonhosted.org/packages/ed/9c/54786362617dd69f624deb05ca0081de9d337c982b61b05d82a69a69d4b5/humanize-4.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/9c/54786362617dd69f624deb05ca0081de9d337c982b61b05d82a69a69d4b5/humanize-4.2.2.tar.gz
...
%prep
%setup -q -n humanize-4.2.2
cd %{_builddir}/humanize-4.2.2
pushd ..
cp -a humanize-4.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656442240
...
cp %{_builddir}/humanize-4.2.2/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
