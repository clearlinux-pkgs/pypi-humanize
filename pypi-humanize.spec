...
Version  : 4.2.0
Release  : 8
URL      : https://files.pythonhosted.org/packages/18/1a/bb33c9d021a427e4f32115b2ab787ba63e97e409e010641356a89adac0f7/humanize-4.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/18/1a/bb33c9d021a427e4f32115b2ab787ba63e97e409e010641356a89adac0f7/humanize-4.2.0.tar.gz
...
%prep
%setup -q -n humanize-4.2.0
cd %{_builddir}/humanize-4.2.0
pushd ..
cp -a humanize-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655669723
...
cp %{_builddir}/humanize-4.2.0/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
