...
Source0  : https://files.pythonhosted.org/packages/cb/77/8d28a520bc30a5a875ce341e2acd9c18ffb03d8c02116257330017394fa9/humanize-4.2.3.tar.gz
...
%prep
%setup -q -n humanize-4.2.3
cd %{_builddir}/humanize-4.2.3
pushd ..
cp -a humanize-4.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656599125
...
cp %{_builddir}/humanize-4.2.3/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
