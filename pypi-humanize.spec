...
Source0  : https://files.pythonhosted.org/packages/f5/11/2634362bfe1db5e7d5cd92cd6d1be023005d00062dcf1c0bdb6699ed5e13/humanize-3.14.0.tar.gz
...
%prep
%setup -q -n humanize-3.14.0
cd %{_builddir}/humanize-3.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643645706
...
cp %{_builddir}/humanize-3.14.0/LICENCE %{buildroot}/usr/share/package-licenses/pypi-humanize/bb7ef51103bdeb7a12af17acbf39fda04e6e354e
