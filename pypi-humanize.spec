...
Source0  : https://files.pythonhosted.org/packages/de/ec/c9fa9a0e2b917bd74c18f9752912fd389b7d8e796cfb864e3c485a9bda5d/humanize-4.5.0.tar.gz
...
%prep
%setup -q -n humanize-4.5.0
cd %{_builddir}/humanize-4.5.0
pushd ..
cp -a humanize-4.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675095577
