...
Source0  : https://files.pythonhosted.org/packages/e0/84/ae8e64a6ffe3291105e9688f4e28fa65eba7924e0fe6053d85ca00556385/humanize-4.12.2.tar.gz
...
%prep
%setup -q -n humanize-4.12.2
cd %{_builddir}/humanize-4.12.2
pushd ..
cp -a humanize-4.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742848338
