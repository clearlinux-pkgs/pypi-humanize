...
Source0  : https://files.pythonhosted.org/packages/22/d1/bbc4d251187a43f69844f7fd8941426549bbe4723e8ff0a7441796b0789f/humanize-4.12.3.tar.gz
...
%prep
%setup -q -n humanize-4.12.3
cd %{_builddir}/humanize-4.12.3
pushd ..
cp -a humanize-4.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746025537
